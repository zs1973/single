package com.planet.floatingview.draggable;
...
import com.planet.floatingview.FloatingView;
...
public abstract class BaseDraggable implements View.OnTouchListener {
     ...
     * Toast 显示后回调这个类
     */
    public void start(FloatingView toast) {
        mFloatingView = toast;
    ...
    protected FloatingView getXToast() {
