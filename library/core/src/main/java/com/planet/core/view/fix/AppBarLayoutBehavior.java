...
public class AppBarLayoutBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        LogUtil.d("onInterceptTouchEvent:" + child.getTotalScrollRange());
     ...
     *
     * @param appBarLayout 目标AppBarLayout
     */
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
        ...
        LogUtil.d("onNestedPreScroll:" + child.getTotalScrollRange()
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        LogUtil.d("onNestedScroll: target:" + target.getClass() + " ,"
    ...
    @Override
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout abl,
    ...
    private static class LogUtil {
        static void d(String string) {
            Log.d(AppBarLayoutBehavior.TAG, string);
        }
    }
