 ...
 *描述：华为-荣耀
 **/
object MagicUiPermissionUtils:OsPermissionUtil {
    ...
    override fun autoStartSetting(context: Context) {
        val intent = Intent()
        intent.component =
            ComponentName.unflattenFromString("com.hihonor.systemmanager/com.hihonor.systemmanager.mainscreen.MainScreenActivity")
