...
public class SDCardHelper {
	...
	public static boolean saveFileToSDCardPublicDir(byte[] data, String type,
		...
		if (isSDCardMounted()) {
			File file = AppUtils.getApp().getExternalFilesDir(type);
			try {
	...
	public static String getSDCardPublicDir(String type) {
		return AppUtils.getApp().getExternalFilesDir(type).toString();
	}
 
	// 获取SD卡私有Cache目录的路径
	public static String getSDCardPrivateCacheDir(@NotNull Context context) {
		return context.getExternalCacheDir().getAbsolutePath();
	}
 
	// 获取SD卡私有Files目录的路径
	public static String getSDCardPrivateFilesDir(@NotNull Context context, String type) {
