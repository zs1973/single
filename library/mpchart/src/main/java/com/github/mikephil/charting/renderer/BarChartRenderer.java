...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    private float[] mRoundCornerRadius = {14f, 14f, 14f, 14f, 14f, 0f, 0f, 0f};
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                    buffer.buffer[j + 3],Utils.convertDpToPixel(2),Utils.convertDpToPixel(2), mRenderPaint);

//            mRoundRectF.left = buffer.buffer[j];
//            mRoundRectF.top =buffer.buffer[j + 1];
//            mRoundRectF.right = buffer.buffer[j + 2];
//            mRoundRectF.bottom = buffer.buffer[j + 3];
//            mRoundRectPath.addRoundRect(mRoundRectF,mRoundCornerRadius,Path.Direction.CCW);
//            c.drawRoundRect(mRoundRectF,5.0f,5.0f,mRenderPaint);
