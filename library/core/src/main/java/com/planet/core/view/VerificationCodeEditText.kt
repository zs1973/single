...
import com.planet.utils.KeyboardUtils
import java.util.*
 ...
 * 验证码输入框
 *
 * [验证码输入框实现](https://github.com/kongpf8848/ViewWorld/blob/master/app/src/main/java/com/github/kongpf8848/viewworld/utis/KeyboardUtils.kt)
 *
 * [用法](https://github.com/kongpf8848/ViewWorld)
 */
...
//        )
    ...
    private fun drawCursor(canvas: Canvas) {
        ...
        if (mCursorFlag) {
            if (mCursorDrawable == null && mCursorDrawableRes != 0) {
                mCursorDrawable =ContextCompat.getDrawable(context,mCursorDrawableRes)
            }
